...
import { PoseLandmarks, PoseLandmark } from '../utils/poseDetection';

const { width, height } = Dimensions.get('window');

interface ReferenceSkeletonOverlayProps {
  drillId: string;
  screenWidth: number;
  screenHeight: number;
  opacity?: number;
...
const getIdealPose = (drillId: string): PoseLandmarks | null => {
...
const createLine = (
  p1: PoseLandmark | undefined,
  p2: PoseLandmark | undefined,
  key: string,
  opacity: number
