...
import { BodyMetrics, getAngleDifference } from './kinematics';
import { PoseLandmarks } from './poseDetection';

export interface DrillRule {
  id: string;
  name: string;
  check: (metrics: BodyMetrics, landmarks: PoseLandmarks, previousState?: any) => RuleResult;
  priority: number;
}
...
export interface RuleResult {
  ...
  targetAngle?: number;
  currentAngle?: number;
  correction?: string; // e.g., "Bend knees 15° more"
}

/**
 * Stance Drill Rules
 */
export function getStanceRules(): DrillRule[] {
 ...
 * Pop-Up Drill Rules
 */
export function getPopUpRules(): DrillRule[] {
 ...
 */
export function getPaddlingRules(): DrillRule[] {
 ...
 */
export function getBottomTurnRules(): DrillRule[] {
 ...
 * Pumping Drill Rules
 */
export function getPumpingRules(): DrillRule[] {
 ...
 */
export function getTubeStanceRules(): DrillRule[] {
 ...
 */
export function getDrillRules(drillId: string): DrillRule[] {
  switch (drillId) {
    case 'stance':
 ...
 */
export function evaluateDrillRules(
  drillId: string,
  metrics: BodyMetrics,
